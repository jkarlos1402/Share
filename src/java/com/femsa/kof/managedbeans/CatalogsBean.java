...
import com.femsa.kof.dao.ShareCatFabricanteDAO;
...
public class CatalogsBean implements Serializable {
    ...
    public void saveCategory() {
        ...
        if (categoriasDAO.saveCategoria(categoriaSelected)) {
            ...
            message = new FacesMessage(FacesMessage.SEVERITY_FATAL, "Error", "There was a error while saving the category");
    ...
    public void saveCountry() {
        ...
        if (paisDAO.savePais(paisSelected)) {
            ...
            message = new FacesMessage(FacesMessage.SEVERITY_FATAL, "Error", "There was a error while saving the country, table is already exists");
    ...
    public void saveGroupCategory() {
        ...
        if (grupoCategoriasDAO.saveGroupCategory(grupoCategoriaNew)) {
            ...
            message = new FacesMessage(FacesMessage.SEVERITY_FATAL, "Error", "There was a error while saving the group category");
