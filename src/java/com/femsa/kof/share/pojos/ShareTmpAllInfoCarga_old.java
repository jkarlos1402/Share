...
public class ShareTmpAllInfoCarga_old implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ShareTmpAllInfoCarga_old)) {
            return false;
        }
        ShareTmpAllInfoCarga_old other = (ShareTmpAllInfoCarga_old) object;
