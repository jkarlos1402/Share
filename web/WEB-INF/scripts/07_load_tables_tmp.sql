...
TRUNCATE TABLE SHARE_ST_INFO_G_CAT_FAB_DASH;
TRUNCATE TABLE SHARE_ST_INFO_CAT_FAB_DASH;
...
UPDATE SHARE_ST_INFO_G_CAT_FAB_DASH SET INDICADOR = 'SOM' WHERE INDICADOR IS NULL;
COMMIT;
...
UPDATE SHARE_ST_INFO_G_CAT_FAB_DASH SET INDICADOR = 'SOS' WHERE INDICADOR IS NULL;
COMMIT;
...
UPDATE SHARE_ST_INFO_CAT_FAB_DASH SET INDICADOR = 'SOM' WHERE INDICADOR IS NULL;
COMMIT;
...
UPDATE SHARE_ST_INFO_CAT_FAB_DASH SET INDICADOR = 'SOS' WHERE INDICADOR IS NULL;
COMMIT;
