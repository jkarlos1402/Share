...
USING (SELECT DISTINCT PAIS FROM SHARE_TMP_AR_INFO_CARGA WHERE NOT PAIS IS NULL)TMP 
...
USING (SELECT DISTINCT CANAL FROM SHARE_TMP_AR_INFO_CARGA WHERE NOT CANAL IS NULL)TMP 
...
USING (SELECT DISTINCT GRUPO_CATEGORIA FROM SHARE_TMP_AR_INFO_CARGA WHERE NOT GRUPO_CATEGORIA IS NULL)TMP 
...
USING (SELECT DISTINCT CATEGORIA FROM SHARE_TMP_AR_INFO_CARGA WHERE NOT CATEGORIA IS NULL)TMP 
...
USING (SELECT DISTINCT FABRICANTE FROM SHARE_TMP_AR_INFO_CARGA WHERE NOT FABRICANTE IS NULL)TMP 
