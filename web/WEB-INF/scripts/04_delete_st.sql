...
/*CREATE TABLE SHARE_TMP_AR_G_CAT_TOTAL AS
SELECT * FROM ( SELECT DISTINCT * FROM SHARE_ST_INFO_G_CAT
WHERE FABRICANTE LIKE '%TOTAL%');*/

CREATE TABLE SHARE_TMP_AR_G_CAT_TOTAL AS
SELECT * FROM ( SELECT DISTINCT * FROM SHARE_TMP_AR_INFO --SHARE_ST_INFO_G_CAT
...
FROM SHARE_TMP_AR_G_CAT_TOTAL TMP
...
DROP TABLE SHARE_TMP_AR_G_CAT_TOTAL;
...
/*CREATE TABLE SHARE_AR_INFO_NARTD_TOTAL AS
SELECT * FROM ( SELECT DISTINCT * FROM SHARE_ST_INFO_G_CAT
WHERE FABRICANTE LIKE '%TOTAL%');*/
...
SELECT SUM(VOLUMEN_AA)
FROM SHARE_AR_INFO_NARTD_TOTAL TMP 
WHERE TMP.FECHA = INFO.FECHA
AND TMP.PAIS = INFO.PAIS)
WHERE PAIS = 'ARGENTINA';
COMMIT;
...
--- ELIMINAR TABLA TEMPORAL CALCULOS TOTALES ---
DROP TABLE SHARE_AR_INFO_NARTD_TOTAL;
...
/*CREATE TABLE SHARE_AR_INFO_CANAL_TOTAL AS
...
SELECT SUM(VOLUMEN_AA)
FROM SHARE_AR_INFO_CANAL_TOTAL TMP
WHERE TMP.FECHA = INFO.FECHA
AND TMP.PAIS = INFO.PAIS
...
--- ELIMINAR TABLA TEMPORAL CALCULOS TOTALES ---
DROP TABLE SHARE_AR_INFO_CANAL_TOTAL;
...
/********************* SHARE - CALCULA LOS INDICADORES YTD,MA,AA TOTALES NARTD **************************/
/*CREATE TABLE SHARE_AR_CANAL_NARTD_TOTAL AS
SELECT * FROM ( SELECT DISTINCT * FROM SHARE_ST_INFO_G_CANAL
WHERE FABRICANTE LIKE '%TOTAL%');*/
...
SELECT SUM(VOLUMEN_AA)
FROM SHARE_AR_CANAL_NARTD_TOTAL TMP 
WHERE TMP.FECHA = INFO.FECHA
AND TMP.PAIS = INFO.PAIS
AND TMP.CANAL = INFO.CANAL)
WHERE PAIS = 'ARGENTINA';
...
--- ELIMINAR TABLA TEMPORAL CALCULOS TOTALES ---
DROP TABLE SHARE_AR_CANAL_NARTD_TOTAL;
