...
FROM SHARE_TMP_AR_INFO_CARGA TMP
...
/****** ACTUALIZACIÓN DE CAMPOS TIEMPO **********/

UPDATE SHARE_TMP_AR_INFO TMP SET TMP.TIEMPO = (SELECT ID_TIEMPO FROM DIM_TIEMPO DIM WHERE TMP.ANIO=DIM.ANIO AND TMP.MES=DIM.MESCORTO);
COMMIT;
